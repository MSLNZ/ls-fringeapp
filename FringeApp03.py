...
"""
print("starting fringe app verion 4.0...")
...
class FringeManager:
    ...
    def load_gauge_data(self):
        ...
        txt_name = filedialog.askopenfilename(parent=application_window,initialdir=os.getcwd(),title="Select text file written by excel",filetypes=my_filetypes)
    ...
    def calculate_output(self, output_all_orders):
        ...
        #out_filename = EasyDialogs.AskFileForSave(message='Select text file to save calculated resuts to',savedFileName=out_filename)
        out_filename = filedialog.asksaveasfilename(parent=application_window,initialdir=os.getcwd(),title="Select text file to save calculated resuts to",filetypes=my_filetypes)
